...
- With  observations, the average of that repayment rate is , standard deviation is 
- Does the average college have a repayment rate of 50\%?
- If it does, then the mean of a sample of observations should follow a distribution of $N(.5, \sigma/\sqrt{20890})$
...
- The probability of getting $\bar{X} =$  or something even higher is  It rounds to 0 here but it's just an extremely small number. This is a *one-tailed p-value*
- The probability of getting $\bar{X} =$ or something *equally far away or farther from .5 in either direction* is `2*(1-pnorm(.575, .5, .0013)`, a *two-tailed p-value*
